...
module "rds-aurora" {
  ...
  db_cluster_parameter_group_description = "${var.database_name} example cluster parameter group"
  ...
  db_parameter_group_description = "${var.database_name} example DB parameter group"
